...
export const projects: ProjectList = [
  {
    ...
    style: {
      cardHoverClass: "hover:bg-white/[0.06]",
      cardDescriptionToneClass: "text-slate-400",
  ...
  },
  {
    ...
    style: {
      cardHoverClass: "hover:bg-white/[0.06]",
      cardDescriptionToneClass: "text-slate-300",
      cardVideoWrapperExtraClass: "bg-black",
      cardCtaExtraClass: "font-semibold",
      detailBodyClass: "space-y-6 mt-4",
    },
  },
  ...
  },
  {
    ...
    style: {
      cardHoverClass: "hover:bg-white/[0.07]",
      cardDescriptionToneClass: "text-slate-400",
      cardVideoWrapperExtraClass: "bg-black",
